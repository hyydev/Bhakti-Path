...
from .views import ProductCreateUpdateview,ProductListView,ProductDetailView , InventoryListCreateAPIView ,InventoryRetrieveUpdateDestroyAPIView ,CategoryListAPIView
