...
class UserManager(BaseUserManager):
    def create_user(
        self, email, full_name, mobile_number, password=None, **extra_fields
    ):
        if not email:
    ...
    def create_superuser(
        ...
        return self.create_user(
            email, full_name, mobile_number, password, **extra_fields
        )
...
class UserProfile(Baseclass):
    ...
    profile_picture = models.ImageField(
        upload_to="user_profile_pictures/", null=True, blank=True
    )
