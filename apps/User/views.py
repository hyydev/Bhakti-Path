...
class UserDetailView(APIView):
    ...
    def get(self, request, user_id):
        ...
        return Response(
            {"message": "  User Detail fetched successfully", "data": serializer.data},
            status=status.HTTP_200_OK,
        )
...
class UserProfileView(APIView):
    ...
    def patch(self, request, id):
        ...
        return Response(
            {"message": "User profile updated successfully", "data": serilaizer.data},
            status=status.HTTP_200_OK,
        )
...
class UserAddressView(APIView):
    ...
    def get(self, request):
        ...
        return Response(
            {"message": "User addresses fetched successfully", "data": serializer.data},
            status=status.HTTP_200_OK,
        )
    ...
    def post(self, request):
        ...
        return Response(
            {"message": "User address created successfully", "data": serializer.data},
            status=status.HTTP_201_CREATED,
        )
    ...
    def patch(self, request, address_id):
        ...
        serializer.save()
        return Response(
            {"message": "User address updated successfully", "data": serializer.data},
            status=status.HTTP_200_OK,
        )
...
class SetDefaultAddressView(APIView):
    ...
    def post(self, request, address_id):
        ...
        return Response(
            {"message": "Default address set successfully"}, status=status.HTTP_200_OK
        )
